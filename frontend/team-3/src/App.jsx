  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="/courses" element={<div className="min-h-screen flex items-center justify-center"><h1 className="text-3xl font-bold">Courses Page - Coming Soon</h1></div>} />
        ...
        <Route path="/support" element={<div className="min-h-screen flex items-center justify-center"><h1 className="text-3xl font-bold">Support Page - Coming Soon</h1></div>} />
      </Route>

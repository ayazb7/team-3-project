...
('emma_jones', 'emma.jones@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 1 DAY)),
('david_kim', 'david.kim@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 1 DAY)),
('lisa_brown', 'lisa.brown@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 1 DAY)),
 
-- Moderate activity (3 days ago) - 3 users
('james_wilson', 'james.wilson@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 3 DAY)),
('maria_garcia', 'maria.garcia@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 3 DAY)),
('robert_taylor', 'robert.taylor@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 3 DAY)),
 
-- Low activity (7 days ago) - 1 user
('anna_martinez', 'anna.martinez@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 7 DAY)),
 
-- Peak activity (10 days ago) - 4 users
('john_anderson', 'john.anderson@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 10 DAY)),
('sophia_lee', 'sophia.lee@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 10 DAY)),
('william_thomas', 'william.thomas@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 10 DAY)),
('olivia_white', 'olivia.white@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 10 DAY)),
 
-- Moderate activity (15 days ago) - 2 users
('michael_harris', 'michael.harris@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 15 DAY)),
('emily_clark', 'emily.clark@email.com', '$2b$12$5MFsjRaeD/eE7WLrY6XqtO8BIDD90pGuxrYVzeJsOQg3koBEh8rxm', 'user', 'English', DATE_SUB(NOW(), INTERVAL 15 DAY));

...
2,
 ...
 'Gain the skills to craft clear, professional emails in any business context — from subject lines to sign-offs.',
 'Intermediate',
 30,
 45,
 'In this intermediate-level course you’ll refine your email writing approach: understand tone, structure your message for impact, and handle replies and follow-ups with confidence.',
 '[
   "Write engaging subject lines that get opened",
   "Structure your emails for clarity and action",
   "Use proper tone and etiquette for different audiences",
   "Manage inbox workflows and follow-up strategies"
 ]',
...
(
3,
 'Mastering Spreadsheets for Business',
 'Unlock the power of spreadsheets for real-world tasks: from budgeting and pivot tables to charting and automation.',
 'Intermediate',
 60,
 90,
 'In this hands-on course you’ll go beyond basic formulas: you’ll learn how to analyse data, automate workflows, and visualise your insights with spreadsheets.',
 '[
   "Create and use advanced formulas and functions",
   "Analyse data with pivot tables and filters",
   "Build interactive charts and dashboards",
   "Automate repetitive tasks using macros or scripts"
 ]',
 'https://images.unsplash.com/photo-1529078155058-5d716f45d604?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2669'
);
